...
is(Database::Typhoon::d_dbdpath('../../osdb-typhoon/examples'), S_OKAY);
is(Database::Typhoon::d_dbfpath('../../osdb-typhoon/examples'), S_OKAY);
is(Database::Typhoon::d_open("demo", "x"), S_OKAY);
